...
function changeState() {
  ...
  player2 = new Player(window.innerWidth/8, window.innerHeight/2)
  /////crowd.loop()
  /////bgm.loop()
...
function shootState() {
  ...
  rope1 = new Rope(ball.body, {x: window.innerWidth/1.5, y: window.innerHeight/2}, playerSprite.x, playerSprite.y)
}
